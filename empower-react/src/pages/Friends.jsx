...
const PHASE_COLORS = {
  ...
  'Early luteal': { dot:'#f2df85', bg:'#fbf3d6', text:'#5a4a10' },
  'Mid luteal':   { dot:'#e6c447', bg:'#f7ebc2', text:'#5a3f08' },
  'Late luteal':  { dot:'#cf9e18', bg:'#f3e2b0', text:'#4a3200' },
  Luteal:         { dot:'#e6c447', bg:'#f7ebc2', text:'#5a3f08' },

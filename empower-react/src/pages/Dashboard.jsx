...
export default function Dashboard() {
  ...
  const { phase, subPhase, cycleDay, cycleLen, daysLeft, confidence, bw, bcProteinG, bcBleedDay, bcInBleedWindow, alreadyLogged, recentLogs, twoWeekLogs, anomalyItems, alloLoad, isPath4 } = d

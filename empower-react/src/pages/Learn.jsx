...
const ARTICLES = {
  ...
  sleep: {
    ...
    content: [
      ...
      { ul: ['Keep the bedroom cool. 18 to 20 degrees Celsius. Especially important in the luteal phase when your core temperature is already elevated.', 'Consistent sleep and wake times. Circadian rhythm stability helps buffer against the hormonal disruption of late luteal. Even on weekends.', 'Magnesium glycinate before bed (studies use around 300 to 400mg) is associated with better sleep quality and falling asleep faster, and is well tolerated. Check with your doctor before starting. (Abbasi B et al. J Res Med Sci 2012)', 'Protein before bed in the luteal phase. Progesterone causes your body to break down muscle protein faster overnight — a small protein snack helps offset this.', 'Reduce alcohol. Even moderate alcohol fragments sleep architecture and reduces REM sleep.', 'Limit caffeine after 12pm. Caffeine has a half-life of 5 to 6 hours and reduces slow-wave sleep even when you feel like you slept fine.'] },

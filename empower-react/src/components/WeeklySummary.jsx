// Weekly summary modal + dashboard card — component exports only (fast-refresh compatible).
// Utility functions (buildWeeklySummary, markWeeklySummaryDismissed, etc.) are in
// ../lib/weeklySummaryUtils — import from there directly.

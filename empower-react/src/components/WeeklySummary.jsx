// Weekly summary modal + dashboard card — components only.
// Non-component utilities (buildWeeklySummary, markWeeklySummaryDismissed, etc.)
// live in ../lib/weeklySummaryUtils to satisfy React Fast Refresh constraints.
